        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="d-flex flex-row justify-content-between mb-3">
              <h1>User</h1>
              <button role="submit" name="multiple_user_delete" class="btn btn-danger delSelect">Delete Selection User</button>
              <a role="button" class="btn btn-primary userAdv" href="chart/user.php">User Advanced Dashboard</a>
            </div>
          </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <table id="example2" class="table table-bordered table-hover display responsive nowrap">
                      ...
                      <tbody>
                        <?php
                        $result = mysqli_query($conn, "SELECT * FROM user_data WHERE status = 'ACTIVE' ORDER BY user_id ASC ");
                        while ($user_data = mysqli_fetch_array($result)) {
                        ?>

                          <?php
                          echo "<tr>";
                          echo "<td class='d-flex justify-content-around align-items-center cekUser'><input type='checkbox' name='multiple_user_select[]' value='$user_data[user_id]'>" . $user_data['user_id'] . "</td>";
                          echo "<td>" . $user_data['nama'] . "</td>";
                          echo "<td>" . $user_data['user_email'] . "</td>";
                          echo "<td>" . $user_data['phone_number'] . "</td>";
                          echo "<td>" . $user_data['tanggal_lahir'] . "</td>";
                          echo "<td>" . $user_data['alamat'] . "</td>";
                          echo "<td><a href='edit_user.php?id=$user_data[user_id]' class='btn btn-sm btn-info btx inf'>Edit</a><hr><a href='model/delete_user.php?id=$user_data[user_id]' class='btn btn-sm btn-danger btx dan'>Delete</a></td>";
                          echo "</tr>"; ?>
                        <?php
                        }
