...
if (isset($_POST['pertanyaan'])) {
    ...
    mysqli_query($conn, "INSERT INTO user_aut (user_email,pertanyaan,jawaban) VALUES ('$email','$pertanyaan','$jawaban')");
}
...
if (isset($_POST['update'])) {
    ...
    $prov = $_POST['change_prov'];
    $kab = $_POST['change_kab'];
    $kec = $_POST['change_kec'];
    $kel = $_POST['change_kel'];
    $alamat = "$prov-$kab-$kec-$kel";
